...
<input type="button" value="Add Student"
				...
				<br/><br/>
				<input type="button" value="FindById"
				onclick="window.location.href='findbyid'; return false;"
				class="btn btn-primary" />
				<br/><br/>
				<input type="button" value="FindByName"
				onclick="window.location.href='findbyname'; return false;"
				class="btn btn-primary" />
				<br/><br/>
